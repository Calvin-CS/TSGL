...
CPP_SRCS += \
../src/tests/Langton/AntFarm.cpp \
../src/tests/Langton/LangtonAnt.cpp 

OBJS += \
./src/tests/Langton/AntFarm.o \
./src/tests/Langton/LangtonAnt.o 

CPP_DEPS += \
./src/tests/Langton/AntFarm.d \
./src/tests/Langton/LangtonAnt.d 


# Each subdirectory must supply rules for building sources it contributes
src/tests/Langton/%.o: ../src/tests/Langton/%.cpp
	@echo 'Building file: $<'
