...
CPP_SRCS += \
../src/tests/Voronoi/ShadedVoronoi.cpp \
../src/tests/Voronoi/Voronoi.cpp 

OBJS += \
./src/tests/Voronoi/ShadedVoronoi.o \
./src/tests/Voronoi/Voronoi.o 

CPP_DEPS += \
./src/tests/Voronoi/ShadedVoronoi.d \
./src/tests/Voronoi/Voronoi.d 


# Each subdirectory must supply rules for building sources it contributes
src/tests/Voronoi/%.o: ../src/tests/Voronoi/%.cpp
	@echo 'Building file: $<'
