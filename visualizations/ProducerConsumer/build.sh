...
echo "Linking..." && echo
#g++ -Llib/ -L"/home/christiaan/workspace/TSGL/src/glad" -L/usr/local/lib -L/usr/lib -L/usr/X11/lib/ -L/opt/AMDAPP/lib/x86_64/ -fopenmp -o "ProducerConsumer"  *.o  -lfreetype -ldl -lm -lGLEW -lglfw -lX11 -lGL -lXrandr
g++ -L../../src/ -Llib/ -L/usr/local/lib -L/usr/lib -L/usr/X11/lib/ -L/opt/AMDAPP/lib/x86_64/ -fopenmp *.o -o "ProducerConsumer" -lfreetype -ldl -lglfw -lX11 -lGL -lXrandr
