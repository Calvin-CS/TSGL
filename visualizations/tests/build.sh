...
cowsay "Now building testCircles..."
...
echo "Linking..." && echo
g++ -Llib/ -L/usr/local/lib -L/usr/lib -L/usr/X11/lib/ -L/opt/AMDAPP/lib/x86_64/ -fopenmp *.o -o "testCircles" -lfreetype -lGLEW -lglfw -lX11 -lGL -lXrandr
