...
%run% testColorWheel.exe 640 640                 
...
%run% testGradientWheel.exe 640 640              
%run% testGraydient.exe 400 400 8                
%run% testGreyscale.exe 640 480 8                
%run% testHighData.exe
%run% testImage.exe
%run% testImageCart.exe              
