...
Rectangle::Rectangle(float x, float y, float width, float height, const ColorFloat fillColor, const ColorFloat outlineColor, bool filled, bool outlined) : ConvexPolygon(4, filled, outlined) {
