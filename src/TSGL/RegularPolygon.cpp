...
RegularPolygon::RegularPolygon(float x, float y, float radius, int sides, const ColorFloat& color, const ColorFloat& outlineColor) : ConvexPolygon(sides,color,outlineColor) {
