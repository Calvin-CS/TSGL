...
class TriangleStrip : public ConvexPolygon {
 ...
 public:
     ...
     */
    TriangleStrip(int numVertices, int x[], int y[], ColorFloat color, bool filled = true, bool outlined = false);

    TriangleStrip(int numVertices, int x[], int y[], ColorFloat color[], bool filled = true, bool outlined = false);

    TriangleStrip(int numVertices, int x[], int y[], ColorFloat fillColor, ColorFloat outlineColor, bool filled = true, bool outlined = false);
