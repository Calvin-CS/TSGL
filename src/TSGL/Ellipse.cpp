...
Ellipse::Ellipse(float x, float y, float xRadius, float yRadius, const ColorFloat& color = BLACK, bool filled, bool outlined) : ConvexPolygon((xRadius + yRadius) / 2, filled, outlined) {
